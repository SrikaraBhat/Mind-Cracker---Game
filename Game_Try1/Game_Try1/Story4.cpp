...
char *Dialogs4[10] = { "Thank you, I am just on time", "Come on lets wish happy birthday to him","Happy birthday to you.","Thank you I really like this."};
int Dcount4 = 4, D4 = 0;
...
void keysp_Story4(int k, int x, int y)
{
	D4++;
	if (D4 >= Dcount4)
	{
...
void displayStory4()
{
	...
	glColor3f(0, 0, 1);
	glRasterPos2f(0, 920);
	for (int i = 0; Dialogs4[D4][i] != '\0'; i++)
		glutBitmapCharacter(GLUT_BITMAP_8_BY_13, Dialogs4[D4][i]);
	glPushMatrix();
	if (D4 == 0)
		glTranslatef(2000, 2000, 0);
	else
		glTranslatef(950, 400, 0);
	glScalef(0.5, 0.5, 0);
	glColor3f(1, 1, 0);
	glBegin(GL_POLYGON);
	glVertex2f(-150, -330);
